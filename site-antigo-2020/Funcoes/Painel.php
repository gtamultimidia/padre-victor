...
class Painel extends Conexao {
    ...
    public function excluirReceita($id) {
        ...
        if ($executa) {
            echo "<meta http-equiv='refresh' content='0;URL=receita-listar.php'>";
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea rows="5" class="form-control" placeholder="Texto Receita" name="textoReceita" required>' . $reg->receita . '</textarea>
                                        </div>
                                    </div>
                                </div>
    ...
    public function excluirProduto($id) {
        ...
        $executa = $listar->execute();
        if ($executa) {
            echo "<meta http-equiv='refresh' content='0;URL=produto-listar.php'>";
    ...
    public function excluir_noticia($id) {
        ...
        $executa = $listar->execute();
        if ($executa) {
            echo "<meta http-equiv='refresh' content='0;URL=noticia-listar.php'>";
