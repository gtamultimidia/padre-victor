...
$(function() {
    ...
    /* mascaras */
    $('head').append('<script src="valida/js/jquery.mask.js" type="text/javascript"></script>');
    /* mascara data */
    ...
    $('head').append('<link href="valida/css/button.css" type="text/css" media="screen" rel="stylesheet" />');
