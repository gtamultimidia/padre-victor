...
<body>
    ...
    <div id="demais" style="position: relative; height: 0px; width: 100%;">
        ...
        <div id="centro_quemSomos">
            <img src="imagens/sombra_dir.png" border="0" id="sombraDirQuemSomos" />
            <img src="imagens/sombra_esq.png" border="0" id="sombraEsqQuemSomos" />
        	<img src="imagens/enfeito_fundo.png" border="0" id="enfeito_fundoQuemSomos" />
            ...
            <?php
				...
				echo '<p align="center" style="font-size: 23px; font-family: Calibri;">'.$resultado['titulo'].'</p>';
