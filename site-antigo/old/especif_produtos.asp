...
<%
	...
	set TB = Conn.execute ("SELECT CONTEUDOINSTITUCIONAL.id, CONTEUDOINSTITUCIONAL.titulo, CONTEUDOINSTITUCIONAL.thumbnail, CONTEUDOINSTITUCIONAL.resumo, CONTEUDOINSTITUCIONAL.materia, CONTEUDOINSTITUCIONAL.datainsercao, CONTEUDOINSTITUCIONAL.albumfotos, CONTEUDOINSTITUCIONAL.nomenomenu FROM CONTEUDOINSTITUCIONAL WHERE ((CONTEUDOINSTITUCIONAL.dataexclusao > date()) or (CONTEUDOINSTITUCIONAL.dataexclusao = #01/01/1900#)) and (CONTEUDOINSTITUCIONAL.ID = " & canal & ") order by datainsercao desc")
