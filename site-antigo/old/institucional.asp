...
<%
	...
	set TB = Conn.execute ("SELECT CONTEUDOINSTITUCIONAL.id, CONTEUDOINSTITUCIONAL.titulo, CONTEUDOINSTITUCIONAL.thumbnail, CONTEUDOINSTITUCIONAL.resumo, CONTEUDOINSTITUCIONAL.materia, CONTEUDOINSTITUCIONAL.datainsercao, CONTEUDOINSTITUCIONAL.albumfotos, CONTEUDOINSTITUCIONAL.nomenomenu FROM CONTEUDOINSTITUCIONAL WHERE ((CONTEUDOINSTITUCIONAL.dataexclusao > date()) or (CONTEUDOINSTITUCIONAL.dataexclusao = #01/01/1900#)) and (CONTEUDOINSTITUCIONAL.nomenomenu = '" & canal & "') order by datainsercao desc")
...
<div class="fundo">
  ...
  <table width="800" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#EECE9B">
    <tr>
      <td><img src="imagens/tit_institucional.jpg" width="479" height="39" vspace="15" />
