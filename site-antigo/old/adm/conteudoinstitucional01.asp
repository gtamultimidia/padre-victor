...
<%
	...
	'-----------------------------------------------------------------------		
		if (request.form <> "") then
			...
			session("SQL") = "SELECT * FROM CONTEUDOINSTITUCIONAL where (1=1)"				
		...
		if (sql = "") or ((request.querystring = "") and (request.form = "")) then
			SQL = "SELECT * FROM CONTEUDOINSTITUCIONAL order by datainsercao desc"
			session("SQL") = ""
		end if
...
<table width="95%" align="center" border="0" cellspacing="0" cellpadding="10" class="table_color">
  <tr>
    <td><a href="acesso.asp">MENU</a> &#8250; CONTE&Uacute;DO INSTITUCIONAL </td>
  </tr>
</table>
<br>
          <table width="95%" border="0" align="center" cellpadding="10" cellspacing="0" class="table_color">
            <tr> 
              <td><img src="imagens/logomarca_peq.gif" width="25" height="25" hspace="5" align="absmiddle">&nbsp;<b>CONTE&Uacute;DO INSTITUCIONAL </b><br>
                <% if session("msg") <> "" then %>
                <br>
                ...
                <table width="95%" border="0" cellpadding="8" cellspacing="0" class="table_borda">
                  <form name="form1" method="post" action="conteudoinstitucional01.asp">
                    <tr>
                      <td></td>
                      <td></td>
                      <td></td>
                ...
                <table width="95%" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td><table width="100%" border="0" cellpadding="4" cellspacing="1">
                        ...
                        <tr>
                          <td width="" bgcolor="<%= cor_fundo %>"><%= ucase(rs("nomenomenu")) %></td>
                          <td width="" bgcolor="<%= cor_fundo %>"><%= ucase(rs("titulo")) %></td>
                          <td bgcolor="<%= cor_fundo %>"><div align="center"><%= formata_data(rs("datainsercao")) %></div></td>
                          <td bgcolor="<%= cor_fundo %>"><div align="right"><a href="conteudoinstitucional02.asp?ID=<%= rs("ID") %>&atividade=editar"><img src="imagens/bt_editar.gif" width="14" height="15" hspace="5" border="0" align="absmiddle" alt="EDITAR"></a><a href="conteudoinstitucional02.asp?ID=<%= rs("ID") %>&atividade=excluir" onClick="return Apaga();"><img src="imagens/bt_excluir.gif" width="11" height="11" border="0" hspace="5" align="absmiddle" alt="EXCLUIR"></a></div></td>
                        </tr>
				  <%
						contador = contador + 1
						rs.movenext
