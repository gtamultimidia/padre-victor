...
<%
	...
	'-----------------------------------------------------------------------		
		if (request.form <> "") then
			...
			session("SQL") = "SELECT * FROM PRODUTOS where (1=1)"
			if palavra_chave = " » BUSCA POR" then palavra_chave = ""
			if palavra_chave <> "" then session("SQL") = session("SQL") & " and ((titulo like '%" & busca_inteligente(palavra_chave) & "%') or (materia like '%" & busca_inteligente(palavra_chave) & "%'))"
			session("SQL") = session("SQL") & " order by titulo"
		end if
...
<table width="95%" border="0" align="center" cellpadding="10" cellspacing="0" class="table_color">
  <tr>
    <td><a href="acesso.asp">MENU</a> &#8250; PRODUTOS </td>
  </tr>
</table>
<br>
          <table width="95%" border="0" align="center" cellpadding="10" cellspacing="0" class="table_color">
            <tr> 
              <td><b><img src="imagens/logomarca_peq.gif" width="25" height="25" hspace="5" align="absmiddle"> PRODUTOS </b><b>: PESQUISA</b><br>
                <% if session("msg") <> "" then %>
                <br>
                ...
                <table width="95%" border="0" cellpadding="8" cellspacing="0" class="table_borda">
                  <form name="form1" method="post" action="produtos01.asp?IDmateria=<%= ID_materia %>">
                    <tr>
                      <td></td>
                      <td></td>
                      <td></td>
                ...
                <table width="95%" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td><table width="100%" border="0" cellpadding="5" cellspacing="0">
                      <tr>
                        <td>&nbsp;</td>
                        <td><div align="right">[&nbsp;<a href="produtos02.asp?atividade=adicionar"  class="link-branco">NOVO CONTE&Uacute;DO </a> ]</div></td>
                      </tr>
                    </table>
                      <table width="100%" border="0" cellpadding="4" cellspacing="1">
                        ...
                        <tr>
                          <td width="100%" height="25" background="imagens/tit_azulclaro_degrade.gif"><strong>PRODUTOS</strong></td>
                        ...
                        <tr>
                          <td bgcolor="<%= cor_fundo %>"><%= ucase(rs("titulo")) %>                            <div align="center"></div></td>
                          <td bgcolor="<%= cor_fundo %>"><div align="right"><a href="produtos02.asp?ID=<%= rs("ID") %>&atividade=editar"><img src="imagens/bt_editar.gif" width="14" height="15" hspace="5" border="0" align="absmiddle" alt="EDITAR"></a><a href="produtos02.asp?ID=<%= rs("ID") %>&atividade=excluir" onClick="return Apaga();"><img src="imagens/bt_excluir.gif" width="11" height="11" border="0" hspace="5" align="absmiddle" alt="EXCLUIR"></a></div></td>
                        </tr>
				  <%
						contador = contador + 1
						rs.movenext
