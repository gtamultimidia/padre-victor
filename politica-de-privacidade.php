    ...
    <body>
        ...
        <div class="politicaPrivacidade">
            <div class="maxPg">
                ...
                <p>A sua privacidade é importante para nós. É política do Café Padre Victor respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site <a href=http://www.padrevictorcafe.com.br/>Café Padre Victor</a>, e outros sites que possuímos e operamos.</p>
                ...
                <p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o Café Padre Victor oferece no site e com caráter enunciativo, mas não limitativo:</p>
                <ul>
                   <li>A) Não se envolver em atividades que sejam ilegais ou contrárias à boa fé a à ordem pública;</li>
                   <li>B) Não difundir propaganda ou conteúdo de natureza racista, xenofóbica, ou sobre cassinos, apostas desportivas, jogos de sorte e azar, qualquer tipo de pornografia ilegal, de apologia ao terrorismo ou contra os direitos humanos;</li>
                   <li>C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do Café Padre Victor, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.</li>
                </ul>
