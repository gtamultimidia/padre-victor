...
<html lang="en">
    <head>
        ...
        <title>Painel Administrativo - Editar Receita</title>
            ...
            <div class="main-panel">
                ...
                <div class="content">
                    <div class="container-fluid">
                        <div class="row">
                            <form method="POST" action="receita-editar.php?id=<?=$_GET['id']?>" enctype="multipart/form-data">
                                <?php $painel->editarReceita();?>
                            </form>
                        </div>
                    </div>
                </div>
