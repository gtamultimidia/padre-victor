...
<html lang="en">
    <head>
        ...
        <title>Painel Administrativo - Listar Produtos</title>
    ...
    <body>
        ...
        <script>
            function confirma_editar(id){
                var resposta = confirm("Deseja mesmo editar a produto selecionada?");
                if (resposta === true) {
                    window.location.href = "produto-editar.php?id="+id;
                }
            }
            function confirma_excluir(id){
                var resposta = confirm("Deseja mesmo excluir a produto selecionada?");
                if (resposta === true) {
                    window.location.href = "produto-excluir.php?id="+id;
                }
            }
            function busca(palavra_chave){
                $.ajax({
                    type: "POST",
                    url: 'produto-buscar.php',   
